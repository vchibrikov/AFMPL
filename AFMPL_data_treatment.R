...
pixel.scale <- 5000/2048
segment.number <- 10

#### height data ####

data.height <- read.csv(file = "output_path/NA_DASP_NA_NA_0.01_NA_S_A_5.021_height_nm.csv", header = TRUE)
data.height %>%
...
data.contour.length <- read.csv(file = "output_path/NA_DASP_NA_NA_0.01_NA_S_A_5.021_contour_length_pixels.csv", header = TRUE)
...
data.shortest.distance <- read.csv(file = "output_path/NA_DASP_NA_NA_0.01_NA_S_A_5.021_shortest_distance_pixels.csv", header = TRUE)
...
data.angle <- read.csv(file = "output_path/NA_DASP_NA_NA_0.01_NA_S_A_5.021_path_angles.csv", header = TRUE)
data.angle %>%
...
data.path.coordinates <- read.csv(file = "output_path/NA_DASP_NA_NA_0.01_NA_S_A_5.021_path_coordinates.csv", header = TRUE)
...
persistence.length.10 <- rbind(msed, bcf, msmd)
persistence.length.10$segment.number <- segment.number

rm(pixel.scale, segment.number, msed, bcf, msmd)
# 
persistence.length <- rbind(persistence.length.1, persistence.length.2, persistence.length.3,
                            persistence.length.4, persistence.length.5, persistence.length.6,
                            persistence.length.7, persistence.length.8, persistence.length.9, persistence.length.10)
